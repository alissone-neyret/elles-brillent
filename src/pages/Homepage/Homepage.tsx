      ...
      <main>
        <section className="homepage_what_section">
          <div>
            ...
            <p>
              ...
              de la Tech (dev, designer, product manager, CTO etc.) pour une
              interview de 25 min chacune.
            </p>
            <p>
        ...
        <section className="homepage_why_section">
          ...
          <div>
            ...
            <p>
              ...
              brillent a germé. Un événement où nous pourrions partager nos
        ...
        <section className="homepage_guests_section">
          <div>
            ...
            <p>Pour la premières édition, les 3 étoiles invitées seront révélées le 13 Novembre.</p>
          </div>
          <img
            className="homepage_illustration --right"
        ...
        <section className="homepage_participation_section --left">
          ...
          <div>
            ...
            <ul>
              ...
              <li>Réseauter : Rejoigns une communauté de passionnés</li>
              <li>
